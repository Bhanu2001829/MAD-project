...
public class StudentViewCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button applybtn = findViewById(R.id.C1applyCourseBtn);
    ...
    private boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (itemID == R.id.course) {
            Intent intent = new Intent(StudentViewCourseActivity.this, ViewCourseActivity.class);
            startActivity(intent);
            return true;
        }
        if (itemID == R.id.home) {
            Intent intent = new Intent(StudentViewCourseActivity.this, GuestHomeActivity.class);
            startActivity(intent);
            return true;
        }
        if (itemID == R.id.branch) {
            Intent intent = new Intent(StudentViewCourseActivity.this, ViewBranchActivity.class);
            startActivity(intent);
            return true;
        }
        return false;
