...
public class AddCourseActivity extends AppCompatActivity {
    ...
    private boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (itemID == R.id.course) {
            Intent intent = new Intent(AddCourseActivity.this, ViewCourseActivity.class);
            startActivity(intent);
            return true;
        }
        if (itemID == R.id.home) {
            Intent intent = new Intent(AddCourseActivity.this, AdminHomeActivity.class);
            startActivity(intent);
            return true;
        }
        if (itemID == R.id.branch) {
            Intent intent = new Intent(AddCourseActivity.this, ViewBranchActivity.class);
            startActivity(intent);
            return true;
        }
        return false;
