...
public class ViewBranchOnMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (itemID == R.id.course) {
            Intent intent = new Intent(ViewBranchOnMapActivity.this, ViewCourseActivity.class);
            startActivity(intent);
            return true;
        }
        if (itemID == R.id.home) {
            Intent intent = new Intent(ViewBranchOnMapActivity.this, AdminHomeActivity.class);
            startActivity(intent);
            return true;
        }
        if (itemID == R.id.branch) {
            Intent intent = new Intent(ViewBranchOnMapActivity.this, ViewBranchActivity.class);
            startActivity(intent);
            return true;
        }
        return false;
