...
public class AdminSeeNotificationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_see_notifications); // Make sure this layout exists
        ...
        Button addAnNotification = findViewById(R.id.addAnNotificationButton);

        addAnNotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent = new Intent(AdminSeeNotificationsActivity.this, NotificationActivity.class);
        ...
        menuimgbtn.setOnClickListener(v -> {
            Intent intent = new Intent(AdminSeeNotificationsActivity.this, ProfileActivity.class);
            startActivity(intent);
        });

        notificationimgbtn.setOnClickListener(v -> {
            Intent intent = new Intent(AdminSeeNotificationsActivity.this, NotificationActivity.class);
            startActivity(intent);
        });
        ...
        firestore.collection("Notification") // Adjusted collection name
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (queryDocumentSnapshots != null && !queryDocumentSnapshots.isEmpty()) {
                        ...
                        Toast.makeText(AdminSeeNotificationsActivity.this, "No Notifications found.", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(AdminSeeNotificationsActivity.this, "Failed to load notification data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
